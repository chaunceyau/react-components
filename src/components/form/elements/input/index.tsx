...
export type FormInputProps = FormInputTextProps | FormInputNumberProps
...
export interface FormInputTextProps extends FormInputCommonProps {
  type?: 'text'
}

export interface FormInputNumberProps extends FormInputCommonProps {
  type?: 'number'
  step: number | string
}
